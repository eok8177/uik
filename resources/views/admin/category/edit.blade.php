...
@section('content')
<h1 class="page-header">@lang('messages.category') <small>{{ $category->title }}</small></h1>

{!! Form::open(['route' => ['admin.category.update', $category->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
    ...
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          ...
          {!! Form::checkbox('enabled', 1, $category->enabled) !!}@lang('messages.enabled')
        </label>
      </div>
    </div>
  </div>
